...
class TimersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create timer" do
    assert_difference('Timer.count') do
      post timers_url, params: { timer: { arrival_time: @timer.arrival_time, require_time: @timer.require_time, title: @timer.title } }
    end
  ...
  test "should update timer" do
    patch timer_url(@timer), params: { timer: { arrival_time: @timer.arrival_time, require_time: @timer.require_time, title: @timer.title } }
